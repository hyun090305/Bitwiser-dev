const translations = {
  ko: {
    ...
    overallRankingList: {text: "로딩 중…"},
      ...
      loginRankLabel: {text: "전체 순위 | 클리어한 스테이지 수"},
  ...
  en: {
    ...
    loginRankLabel: {text: "Global Rank | Stages Cleared"},
    ...
    moduleLoadFailed: {text: "⚠️ Failed to load module: No data"},
