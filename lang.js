const translations = {
  ko: {
    ...
    addRowTopBtn: {text: "+ 행", title: "위쪽 행 추가", ariaLabel: "위쪽 행 추가"},
    removeRowTopBtn: {text: "- 행", title: "위쪽 행 제거", ariaLabel: "위쪽 행 제거"},
    addRowBottomBtn: {text: "+ 행", title: "아래쪽 행 추가", ariaLabel: "아래쪽 행 추가"},
    removeRowBottomBtn: {text: "- 행", title: "아래쪽 행 제거", ariaLabel: "아래쪽 행 제거"},
    addColLeftBtn: {text: "+ 열", title: "왼쪽 열 추가", ariaLabel: "왼쪽 열 추가"},
    removeColLeftBtn: {text: "- 열", title: "왼쪽 열 제거", ariaLabel: "왼쪽 열 제거"},
    addColRightBtn: {text: "+ 열", title: "오른쪽 열 추가", ariaLabel: "오른쪽 열 추가"},
    removeColRightBtn: {text: "- 열", title: "오른쪽 열 제거", ariaLabel: "오른쪽 열 제거"},
    inputLabel: {text: "입력"},
    outputLabel: {text: "출력"},
    rowLabel: {text: "행"},
    colLabel: {text: "열"},
